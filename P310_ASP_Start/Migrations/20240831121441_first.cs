        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LivingPlace = table.Column<string>(maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "bottom1.jpg", "<span>f</span>all ahead" },
                    { 2, "bottom2.jpg", "<span>f</span>all ahead" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 8, 31, 16, 14, 41, 69, DateTimeKind.Local).AddTicks(1362), 0m, false, "w1.jpg", "T-short 1", 100m },
                    { 2, 2, new DateTime(2024, 8, 31, 16, 14, 41, 70, DateTimeKind.Local).AddTicks(325), 0m, false, "w2.jpg", "Bluse 1", 120m },
                    { 3, 2, new DateTime(2024, 8, 31, 16, 14, 41, 70, DateTimeKind.Local).AddTicks(344), 0m, false, "w3.jpg", "Shoes 2", 150m },
                    { 4, 3, new DateTime(2024, 8, 31, 16, 14, 41, 70, DateTimeKind.Local).AddTicks(347), 0m, false, "w4.jpg", "Short 3", 155m }
                });
