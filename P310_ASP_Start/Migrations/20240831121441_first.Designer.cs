...
namespace P310_ASP_Start.Migrations
{
    ...
    [Migration("20240831121441_first")]
    partial class first
    {
            ...
            modelBuilder.Entity("P310_ASP_Start.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 8, 31, 16, 14, 41, 69, DateTimeKind.Local).AddTicks(1362),
                            DiscountedPrice = 0m,
                            HasDiscount = false,
                            Image = "w1.jpg",
                            Name = "T-short 1",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 8, 31, 16, 14, 41, 70, DateTimeKind.Local).AddTicks(325),
                            DiscountedPrice = 0m,
                            HasDiscount = false,
                            Image = "w2.jpg",
                            Name = "Bluse 1",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 8, 31, 16, 14, 41, 70, DateTimeKind.Local).AddTicks(344),
                            DiscountedPrice = 0m,
                            HasDiscount = false,
                            Image = "w3.jpg",
                            Name = "Shoes 2",
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2024, 8, 31, 16, 14, 41, 70, DateTimeKind.Local).AddTicks(347),
                            DiscountedPrice = 0m,
                            HasDiscount = false,
                            Image = "w4.jpg",
                            Name = "Short 3",
            ...
            modelBuilder.Entity("P310_ASP_Start.Models.Slider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title = "The Biggest <span>Sale</span> "
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Title = "SUMMER <span>COLLECTION </span> "
                        },
                        new
                        {
                            Id = 3,
                            Image = "banner3.jpg",
                            SubTitle = "Special for Kamran",
                            Title = "The Biggest <span>Sale</span> "
                        },
                        new
                        {
                            Id = 4,
                            Image = "banner4.jpg",
                            SubTitle = "Special for Ruslan",
                            Title = "The Biggest <span>Perviz ever</span> "
                        });
                });
